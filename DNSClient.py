...
real_name_server = '8.8.8.8'  # Using Google's public DNS server
...
# Testing method for exfiltration (part 2)
...
if __name__ == '__main__':
    ...
    # Test querying the local DNS server with exfiltrate_info function
    result = exfiltrate_info('nyu.edu.', question_type)
    print("Exfiltration test result for nyu.edu:", result)
